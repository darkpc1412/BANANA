...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://clone:clone@cluster0.glncvcj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "clone")
